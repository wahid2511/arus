...
class DownloadSegment {
  ...
  double get progress => length <= 0 ? 0 : (downloaded / length).clamp(0, 1).toDouble();
...
class DownloadTask {
  ...
  factory DownloadTask.fromJson(Map<String, dynamic> json) {
    ...
    return DownloadTask(
      ...
      totalBytes: json['totalBytes'] is num ? (json['totalBytes'] as num).toInt() : null,
  ...
  Map<String, dynamic> toJson({bool includeHeaders = true}) => <String, dynamic>{
        'id': id,
        'url': url,
        'fileName': fileName,
        'filePath': filePath,
        ...
        if (segments != null) 'segments': segments!.map((segment) => segment.toJson()).toList(),
...
class DownloadSettings {
  ...
  factory DownloadSettings.fromJson(Map<String, dynamic> json) {
    return DownloadSettings(
      ...
      maxConcurrentDownloads: _clampInt(json['maxConcurrentDownloads'], 1, 10, 3),
      minSegmentSizeBytes: _clampInt(json['minSegmentSizeBytes'], 64 * 1024, 8 * 1024 * 1024, 512 * 1024),
      maxSegmentRetries: _clampInt(json['maxSegmentRetries'], 0, 10, 3),
      revealOnComplete: json['revealOnComplete'] is bool ? json['revealOnComplete'] as bool : true,
      browserIntegrationEnabled: json['browserIntegrationEnabled'] is bool
          ? json['browserIntegrationEnabled'] as bool
          : true,
      launchAtLogin: json['launchAtLogin'] is bool ? json['launchAtLogin'] as bool : true,
    );
  }
  ...
  DownloadSettings copyWith({
    ...
    return DownloadSettings(
      ...
      browserIntegrationEnabled: browserIntegrationEnabled ?? this.browserIntegrationEnabled,
...
int _intValue(Object? value, [int fallback = 0]) {
  return value is num ? value.toInt() : int.tryParse(value?.toString() ?? '') ?? fallback;
}

double _doubleValue(Object? value, [double fallback = 0]) {
  return value is num ? value.toDouble() : double.tryParse(value?.toString() ?? '') ?? fallback;
}
