...
void main() {
  testWidgets('Arus dashboard renders without an initialized queue', (tester) async {
    final root = Directory('${Directory.systemTemp.path}${Platform.pathSeparator}arus-flutter-widget-test');
    ...
    expect(find.text('Unduhan baru'), findsOneWidget);
